...
tmux send-keys -t tofino './run_switchd.sh -p fifo --arch tofino2' Enter
...
tmux send-keys -t tofino '. /data/set_sde_9.12.0.sh' Enter
tmux send-keys -t tofino './run_pd_rpc.py pd_rpc/port_shaping.py' Enter
