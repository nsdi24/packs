...
class TestbedResultParser:
    ...
    def parse_udp_results(self, alg):
        ...
        # plt.show()
        plt.savefig("projects/aifo/plots/Eval_udp_%s.pdf" % (alg), bbox_inches='tight')
        return
    ...
    def parse_tcp_results(self, alg):
        ...
        l.set_frame_on(False)
        # plt.show()
        plt.savefig("projects/aifo/plots/Eval_tcp_%s.pdf" % (alg), bbox_inches='tight')
...
class SimulationResultParser:
    def __init__(self):
        ...
        self.all_comparison_less_100kb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload/pFabric_less_100KB_mean_fct_ms.dat'
        self.all_comparison_less_100kb_99th_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload/pFabric_less_100KB_99th_fct_ms.dat'
        self.all_comparison_geq_1mb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload/pFabric_geq_1MB_mean_fct_ms.dat'

        # queue length
        self.queue_length_less_100kb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_q_len/pFabric_less_100KB_mean_fct_ms.dat'
        self.queue_length_less_100kb_99th_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_q_len/pFabric_less_100KB_99th_fct_ms.dat'
        self.queue_length_geq_1mb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_q_len/pFabric_geq_1MB_mean_fct_ms.dat'
        self.queue_length_less_100kb_mean_fct_14_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_q_len_1_4/pFabric_less_100KB_mean_fct_ms.dat'
        self.queue_length_less_100kb_99th_fct_14_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_q_len_1_4/pFabric_less_100KB_99th_fct_ms.dat'
        self.queue_length_geq_1mb_mean_fct_14_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_q_len_1_4/pFabric_geq_1MB_mean_fct_ms.dat'

        # window length
        self.window_length_less_100kb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_w_sr/pFabric_less_100KB_mean_fct_ms.dat'
        self.window_length_less_100kb_99th_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_w_sr/pFabric_less_100KB_99th_fct_ms.dat'
        self.window_length_geq_1mb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_w_sr/pFabric_geq_1MB_mean_fct_ms.dat'

        # accepting set
        self.accept_set_aifo_name = f'projects/aifo/plots/aifo_evaluation/selfDefinedFlows/AIFO.dat'
        self.accept_set_tcp_name = f'projects/aifo/plots/aifo_evaluation/selfDefinedFlows/TCP.dat'
        self.accept_set_pifo_name = f'projects/aifo/plots/aifo_evaluation/selfDefinedFlows/PIFO.dat'
        self.accept_set_sppifo_name = f'projects/aifo/plots/aifo_evaluation/selfDefinedFlows/SPPIFO.dat'

        # fairness
        self.fairness_less_100KB_mean_fct_ms_32_name = f'projects/aifo/plots/aifo_evaluation/fairness/web_search_workload/fairness_less_100KB_mean_fct_ms_32.dat'
        self.fairness_split_mean_fct_ms_32_name = f'projects/aifo/plots/aifo_evaluation/fairness/web_search_workload/fairness_split_mean_fct_ms_32.dat'
        self.fairness_less_100KB_99th_fct_ms_32_name = f'projects/aifo/plots/aifo_evaluation/fairness/web_search_workload/fairness_less_100KB_99th_fct_ms_32.dat'

        # K
        self.k_less_100kb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_C_K/pFabric_less_100KB_mean_fct_ms.dat'
        self.k_less_100kb_99th_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_C_K/pFabric_less_100KB_99th_fct_ms.dat'
        self.k_geq_1mb_mean_fct_name = f'projects/aifo/plots/aifo_evaluation/pFabric/web_search_workload_C_K/pFabric_geq_1MB_mean_fct_ms.dat'
    ...
    def fig7a(self):
        ...
        l.set_frame_on(False)
        # plt.show()
        plt.savefig("projects/aifo/plots/7a.pdf", bbox_inches='tight')
        return
    ...
    def fig7b(self):
        ...
        l.set_frame_on(False)
        # plt.show()
        plt.savefig("projects/aifo/plots/7b.pdf", bbox_inches='tight')
        return
    ...
    def fig7c(self):
        ...
        l.set_frame_on(False)
        # plt.show()
        plt.savefig("projects/aifo/plots/7c.pdf", bbox_inches='tight')
        return
    ...
    def fig8a(self):
        ...
        l = plt.legend(loc='upper left', numpoints=1, prop={'size':14}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/8a.pdf", bbox_inches='tight')
        return
    ...
    def fig8b(self):
        ...
        l = plt.legend(loc='upper left', numpoints=1, prop={'size':14}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/8b.pdf", bbox_inches='tight')
        return
    ...
    def fig8c(self):
        ...
        l = plt.legend(loc='upper left', numpoints=1, prop={'size':14}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/8c.pdf", bbox_inches='tight')
        return
    ...
    def fig9a(self):
        ...
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/9a.pdf", bbox_inches='tight')
        return
    ...
    def fig9b(self):
        ...
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/9b.pdf", bbox_inches='tight')
        return
    ...
    def fig9c(self):
        ...
        l = plt.legend(loc='upper center', numpoints=1, prop={'size':14}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/9c.pdf", bbox_inches='tight')
        return
    ...
    def fig10a(self):
        ...
        l = plt.legend(loc='upper left', numpoints=1, prop={'size':14}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/10a.pdf", bbox_inches='tight')
        return
    ...
    def fig10b(self):
        ...
        l = plt.legend(loc='upper left', numpoints=1, prop={'size':14}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/10b.pdf", bbox_inches='tight')
        return
    ...
    def fig11a(self):
        ...
        l.set_frame_on(False)
        # plt.show()
        plt.savefig("projects/aifo/plots/11a.pdf", bbox_inches='tight')
        return
    ...
    def fig11b(self):
        ...
        l = plt.legend(loc='upper left', numpoints=1, prop={'size':14}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/11b.pdf", bbox_inches='tight')
        return
    ...
    def fig12a(self):
        ...
        plt.savefig("projects/aifo/plots/12a.pdf", bbox_inches='tight')
        return
    ...
    def fig12b(self):
        ...
        l.legendHandles[1]._sizes = [9]
        l.legendHandles[2]._sizes = [9]
        plt.savefig("projects/aifo/plots/12b.pdf", bbox_inches='tight')
        return
    ...
    def fig12c(self):
        ...
        l.legendHandles[1]._sizes = [9]
        l.legendHandles[2]._sizes = [9]
        plt.savefig("projects/aifo/plots/12c.pdf", bbox_inches='tight')
        return
    ...
    def fig12d(self):
        ...
        l.legendHandles[1]._sizes = [9]
        l.legendHandles[2]._sizes = [9]
        plt.savefig("projects/aifo/plots/12d.pdf", bbox_inches='tight')
        return
    ...
    def fig14a(self):
        ...
        plt.plot(idx, data.SPPIFOWFQ_32, label='SPPIFO', color=colors[3],\
                marker='^', markersize=6, lw=1, linestyle=linestyles[0], clip_on=False)
        plt.plot(idx, data.AFQ_32, label='AFQ', color=colors[7],\
        ...
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/14a.pdf", bbox_inches='tight')
        return

    def fig14b(self):
        fairness_less_100KB_99th_fct_ms_32 = pd.read_csv(self.fairness_less_100KB_99th_fct_ms_32_name, delim_whitespace=True, header=0)
        data = fairness_less_100KB_99th_fct_ms_32
        fig, ax = plt.subplots(figsize=(5, 3))
        ...
        l = plt.legend(loc='upper left', numpoints=1, prop={'size':12}, labelspacing=0.36)
        l.set_frame_on(False)
        plt.savefig("projects/aifo/plots/14b.pdf", bbox_inches='tight')
        return
    ...
    def fig14c(self):
        ...
        ax.bar(idx[4], _mean_funcs[2], yerr=(low, _99th_funcs[2]), error_kw=dict(lw=1, capsize=3, capthick=1), width=width, align='center', ecolor=colors[5], capsize=10, label = "AFQ", color=colors[7])
        ...
        plt.savefig("projects/aifo/plots/14c.pdf", bbox_inches='tight')
        return
    ...
    def fig16a(self):
        ...
        plt.savefig("projects/aifo/plots/16a.pdf", bbox_inches='tight')
        return
    ...
    def fig16b(self):
        ...
        plt.savefig("projects/aifo/plots/16b.pdf", bbox_inches='tight')
        return
    ...
    def fig16c(self):
        ...
        for i in range(60000 // gap):
            if draw_id[i]==0:
                ...
                s_f_y.append(draw_data[i])
        plt.scatter(range(300), s_f_y[0:300], s[0:300], color=colors[1], label='Rank log')
        plt.savefig("projects/aifo/plots/16c.pdf", bbox_inches='tight')
        return
    ...
    def fig16d(self):
        ...
        for i in range(60000 // gap):
            if draw_id[i]==0:
                ...
                s_f_y.append(draw_data[i])
        plt.scatter(range(300), s_f_y[0:300], s[0:300], color=colors[1], label='Rank log')
        plt.savefig("projects/aifo/plots/16d.pdf", bbox_inches='tight')
        return
