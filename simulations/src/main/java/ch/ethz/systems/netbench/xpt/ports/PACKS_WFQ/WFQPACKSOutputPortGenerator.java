...
public class WFQPACKSOutputPortGenerator extends OutputPortGenerator {
    ...
    public WFQPACKSOutputPortGenerator(long numberQueues, int sizePerQueue, String mappingType, int windowSize, int sampleCount, float kValue, boolean ecnMarking, long ecnThresholdPackets) {
    ...
    public OutputPort generate(NetworkDevice ownNetworkDevice, NetworkDevice towardsNetworkDevice, Link link) {
        return new WFQPACKSOutputPort(ownNetworkDevice, towardsNetworkDevice, link, numberQueues, sizePerQueue, mappingType, windowSize, sampleCount, kValue, ecnMarking, ecnThresholdPackets);
    }
}