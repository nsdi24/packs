...
public class AFQOutputPort extends OutputPort {
    ...
    public AFQOutputPort(NetworkDevice ownNetworkDevice, NetworkDevice targetNetworkDevice, Link link, long numQueues, long perQueueCapacity, long bytesPerRound, boolean ecnMarking, long ecnThresholdPackets) {
