...
import ch.ethz.systems.netbench.xpt.ports.PACKS.PACKSOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.ports.PACKS_WFQ.WFQPACKSOutputPortGenerator;
...
import ch.ethz.systems.netbench.xpt.ports.AIFO.AIFOOutputPortGenerator;
import ch.ethz.systems.netbench.xpt.ports.AIFO_WFQ.WFQAIFOOutputPortGenerator;
...
import ch.ethz.systems.netbench.xpt.udp.UdpTransportLayerGenerator;
...
class InfrastructureSelector {
        ...
        switch (Simulator.getConfiguration().getPropertyOrFail("output_port")) {
            ...
            case "sppifo":
                return new SPPIFOOutputPortGenerator(
                        ...
                        Simulator.getConfiguration().getBooleanPropertyWithDefault("output_port_ecn_marking", false),
                        Simulator.getConfiguration().getLongPropertyWithDefault("output_port_ecn_threshold_packets", 0)
                        );
            ...
            case "wfqaifo":
                return new WFQAIFOOutputPortGenerator(
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_max_size_packets"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_window_size"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_sample_count"),
                        (float) Simulator.getConfiguration().getDoublePropertyOrFail("output_port_k_value"),
                        Simulator.getConfiguration().getBooleanPropertyWithDefault("output_port_ecn_marking", false),
                        Simulator.getConfiguration().getLongPropertyWithDefault("output_port_ecn_threshold_packets", 0)
                );
            ...
            case "packs":
                return new PACKSOutputPortGenerator(
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_number_queues"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_size_per_queue_packets"),
                        Simulator.getConfiguration().getPropertyWithDefault("output_port_mapping_type", "Quantiles"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_window_size"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_sample_count"),
                        (float) Simulator.getConfiguration().getDoublePropertyOrFail("output_port_k_value"),
                        Simulator.getConfiguration().getBooleanPropertyWithDefault("output_port_ecn_marking", false),
            ...
            case "wfqpacks":
                return new WFQPACKSOutputPortGenerator(
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_number_queues"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_size_per_queue_packets"),
                        Simulator.getConfiguration().getPropertyWithDefault("output_port_mapping_type", "Quantiles"),
                        Simulator.getConfiguration().getIntegerPropertyOrFail("output_port_window_size"),
    ...
    static TransportLayerGenerator selectTransportLayerGenerator() {
        ...
        switch (Simulator.getConfiguration().getPropertyOrFail("transport_layer")) {
            ...
            case "udp":
                return new UdpTransportLayerGenerator();
            ...
            case "cbr":
                return new CBRTransportLayerGenerator(
                        ...
                        Simulator.getConfiguration().getBooleanPropertyWithDefault("transport_layer_cbr_ranks_enabled", false),
                        Simulator.getConfiguration().getPropertyWithDefault("transport_layer_cbr_rank_distribution", ""),
                        Simulator.getConfiguration().getLongPropertyWithDefault("transport_layer_cbr_rank_bound", 0)
                );
