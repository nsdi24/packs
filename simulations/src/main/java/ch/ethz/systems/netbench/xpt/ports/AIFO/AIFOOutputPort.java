...
import ch.ethz.systems.netbench.xpt.ports.FIFO.FIFOQueue;
...
public class AIFOOutputPort extends OutputPort {
    ...
    */
    ...
    AIFOOutputPort(NetworkDevice ownNetworkDevice, NetworkDevice targetNetworkDevice, Link link, int maxQueueSize, int windowSize, int sampleCount, float kValue, boolean ecnMarking, long ecnThresholdPackets) {
    ...
    public void enqueue(Packet packet) {
        ...
        if (admit_flag) {
            ...
            if (!getIsSending()) {
                ...
                FIFOQueue queue = (FIFOQueue) getQueue();
