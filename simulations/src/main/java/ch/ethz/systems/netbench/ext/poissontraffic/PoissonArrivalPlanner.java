...
public class PoissonArrivalPlanner extends TrafficPlanner {
    ...
    protected PoissonArrivalPlanner(Map<Integer, TransportLayer> idToTransportLayerMap, double lambdaFlowStartsPerSecond, FlowSizeDistribution flowSizeDistribution) {
    ...
    public Random getOwnIndependentRng() {
        return ownIndependentRng;
    }

    public double getLambdaFlowStartsPerSecond() {
        return lambdaFlowStartsPerSecond;
    }

    public FlowSizeDistribution getFlowSizeDistribution() {
