...
public class BaseAllowedProperties {
    ...
    public static final String[] EXTENSION = new String[]{
            ...
            "output_port_ecn_marking",
            "output_port_ecn_threshold_packets",
    ...
    public static final String[] EXPERIMENTAL = new String[]{
            ...
            // PACKS nicole
            "output_port_weighted_drops",
            "output_port_direction_priority",
            "output_port_time_based",
            "output_port_interval",
            "output_port_bound_adaptation",

            // UDP and CBR
            "UDP_MAX_SEGMENT_SIZE",
            "traffic_file_name",
            "transport_layer_cbr_random_enabled",
            "transport_layer_cbr_ranks_enabled",
            "transport_layer_cbr_rank_distribution",
            "transport_layer_cbr_rank_bound",

            // PACKS
            "output_port_mapping_type",
            "output_port_size_per_queue_packets",

            // AIFO and PACKS
            "output_port_window_size",
            "output_port_k_value",
            "output_port_sample_count",
