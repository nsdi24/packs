...
public class FlowLogger {
    ...
    // of throughput
    private static long STATISTIC_SAMPLE_INTERVAL_BYTES = 50000;
    ...
    public void setFlowSizeByte(long value) {
        this.flowSizeByte = value;
    }
    ...
    public void setStatisticSampleIntervalBytes(long value){
        this.STATISTIC_SAMPLE_INTERVAL_BYTES = value;
    }
}
