...
public class SPPIFOOutputPort extends OutputPort {
    ...
    /**
     * Output Port for SP-PIFO.
     * @param numberQueues: number of queues
     * @param sizePerQueuePackets: size of each queue (in packets)
     * @param stepSize: strategy used to update queue bounds
     */
    public SPPIFOOutputPort(NetworkDevice ownNetworkDevice, NetworkDevice targetNetworkDevice, Link link, long numberQueues, long sizePerQueuePackets, String stepSize, boolean ecnMarking, long ecnThresholdPackets) {
