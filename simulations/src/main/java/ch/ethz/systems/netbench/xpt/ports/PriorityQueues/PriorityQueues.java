...
public class PriorityQueues implements Queue {
    ...
    public PriorityQueues(long numQueues, long perQueueCapacity){
    ...
    public boolean offer(Object o) {
        ...
        if (packet.isTCP()){
            return this.offerToPriorityQueue(packet, (int)((FullExtTcpPacket)packet).getPriority());
        } else {
            return this.offerToPriorityQueue(packet, (int)((FullExtUdpPacket)packet).getPriority());
        }
    }
