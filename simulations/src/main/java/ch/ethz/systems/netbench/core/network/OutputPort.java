    ...
    void dispatch(Packet packet) {
        ...
        if (!queue.isEmpty()) {
            ...
            if (SimulationLogger.hasPacketsTrackingEnabled()) {
                if (packet.isTCP()){
                    FullExtTcpPacket pk = (FullExtTcpPacket) packetFromQueue;
                    SimulationLogger.logPacket("Time: " + Simulator.getCurrentTime() + " => TCP Packet polled: SeqNo: " + pk.getSequenceNumber() + ", ACKNo: " + pk.getAcknowledgementNumber() + ", Priority: " + pk.getPriority());
                } else {
                    FullExtUdpPacket pk = (FullExtUdpPacket) packet;
                    SimulationLogger.logPacket("Time: " + Simulator.getCurrentTime() + " => UDP Packet polled: Priority: " + pk.getPriority());
                }
            }
