...
set output 'projects/packs/plots/udp/inversions_analysis/uniform_rank_distribution/uniform_32_queues/uniform32.pdf'

f(x) = 0
plot "projects/packs/plots/udp/inversions_analysis/uniform_rank_distribution/uniform_32_queues/uniform32.dat" using 2 title "FIFO" w l ls 1 lw 6, \
