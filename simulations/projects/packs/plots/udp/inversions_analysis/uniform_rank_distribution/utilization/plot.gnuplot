...
set output 'projects/packs/plots/udp/inversions_analysis/uniform_rank_distribution/utilization/utilization.pdf'

f(x) = 0
plot "projects/packs/plots/udp/inversions_analysis/uniform_rank_distribution/utilization/utilization.dat" using 1:2 title "FIFO" w lp ls 1 lw 6 , \
