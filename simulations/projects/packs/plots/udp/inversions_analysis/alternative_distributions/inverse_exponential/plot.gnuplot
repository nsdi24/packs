...
set output 'projects/packs/plots/udp/inversions_analysis/alternative_distributions/inverse_exponential/inverse_exponential.pdf'

f(x) = 0
plot "projects/packs/plots/udp/inversions_analysis/alternative_distributions/inverse_exponential/inverse_exponential.dat" using 2 title "FIFO" w l ls 1 lw 6, \
