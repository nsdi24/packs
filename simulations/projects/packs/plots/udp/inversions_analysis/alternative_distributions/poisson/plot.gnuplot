...
set output 'projects/packs/plots/udp/inversions_analysis/alternative_distributions/poisson/poisson.pdf'

f(x) = 0
plot "projects/packs/plots/udp/inversions_analysis/alternative_distributions/poisson/poisson.dat" using 2 title "FIFO" w l ls 1 lw 6, \
