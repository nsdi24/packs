...
set output 'projects/packs/plots/tcp/inversions_analysis/alternative_distributions/convex/convex.pdf'

f(x) = 0
plot "projects/packs/plots/tcp/inversions_analysis/alternative_distributions/convex/convex.dat" using 2 title "FIFO" w l ls 1 lw 6, \
