...
set output 'projects/packs/plots/tcp/inversions_analysis/uniform_rank_distribution/uniform_8_queues/uniform.pdf'

f(x) = 0
plot "projects/packs/plots/tcp/inversions_analysis/uniform_rank_distribution/uniform_8_queues/uniform.dat" using 2 title "FIFO" w l ls 1 lw 6, \
